...
def get_message_content(msg, debug=False):
...
def build_message_tree(mapping, current_id, visited=None, debug=False):
...
def extract_messages_from_mapping(mapping, current_node=None, debug=False):
