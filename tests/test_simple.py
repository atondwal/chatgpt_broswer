...
from ccsm.core.loader import load_conversations, extract_content
...
class TestTUIEnhancements:
    ...
    def test_copy_item(self):
        ...
        from ccsm.tui.action_handler import ActionContext
    ...
    def test_quick_filter(self):
        ...
        from ccsm.tui.tui import ViewMode
    ...
    def test_create_folder_with_selected_items(self):
        ...
        with patch('ccsm.tui.operations_manager.get_input', return_value="Test Folder"):
    ...
    def test_create_folder_without_selection(self):
        ...
        from unittest.mock import patch, Mock
        self.tui.stdscr.getmaxyx.return_value = (24, 80)  # Mock terminal size
        with patch('ccsm.tui.operations_manager.get_input', return_value="Empty Folder"):
